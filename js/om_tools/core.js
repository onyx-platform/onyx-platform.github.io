...
if(typeof om_tools.core.t33757 !== 'undefined'){
} else {

/**
* @constructor
*/
om_tools.core.t33757 = (function (state_proxy,owner,get_state,meta33758){
...
om_tools.core.t33757.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (get_state){
return (function (_33759,meta33758__$1){
var self__ = this;
var _33759__$1 = this;
return (new om_tools.core.t33757(self__.state_proxy,self__.owner,self__.get_state,meta33758__$1));
});})(get_state))
;

om_tools.core.t33757.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (get_state){
...
om_tools.core.t33757.prototype.cljs$core$IDeref$_deref$arity$1 = ((function (get_state){
return (function (_){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t33757.prototype.cljs$core$IReset$_reset_BANG_$arity$2 = ((function (get_state){
return (function (_,v){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t33757.prototype.cljs$core$ISwap$_swap_BANG_$arity$2 = ((function (get_state){
return (function (s,f){
var self__ = this;
var s__$1 = this;
...
om_tools.core.t33757.prototype.cljs$core$ISwap$_swap_BANG_$arity$3 = ((function (get_state){
...
om_tools.core.t33757.prototype.cljs$core$ISwap$_swap_BANG_$arity$4 = ((function (get_state){
...
om_tools.core.t33757.prototype.cljs$core$ISwap$_swap_BANG_$arity$5 = ((function (get_state){
...
om_tools.core.t33757.getBasis = ((function (get_state){
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"state-proxy","state-proxy",1999831324,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(new cljs.core.Symbol(null,"quote","quote",1377916282,null),cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"owner","owner",1247919588,null)], null))),new cljs.core.Keyword(null,"doc","doc",1913296891),"Returns an atom-like object for reading and writing Om component\n   state.\n\n   Note: Behavior may exactly not match atoms when deref'ing\n   immediately following a reset!/swap! because Om processes state\n   changes asynchronously in separate render phases."], null)),new cljs.core.Symbol(null,"owner","owner",1247919588,null),new cljs.core.Symbol(null,"get-state","get-state",-1081972112,null),new cljs.core.Symbol(null,"meta33758","meta33758",-864857948,null)], null);
});})(get_state))
;

om_tools.core.t33757.cljs$lang$type = true;

om_tools.core.t33757.cljs$lang$ctorStr = "om-tools.core/t33757";

om_tools.core.t33757.cljs$lang$ctorPrWriter = ((function (get_state){
return (function (this__19463__auto__,writer__19464__auto__,opt__19465__auto__){
return cljs.core._write.call(null,writer__19464__auto__,"om-tools.core/t33757");
});})(get_state))
;

om_tools.core.__GT_t33757 = ((function (get_state){
return (function om_tools$core$state_proxy_$___GT_t33757(state_proxy__$1,owner__$1,get_state__$1,meta33758){
return (new om_tools.core.t33757(state_proxy__$1,owner__$1,get_state__$1,meta33758));
});})(get_state))
;

}

return (new om_tools.core.t33757(om_tools$core$state_proxy,owner,get_state,cljs.core.PersistentArrayMap.EMPTY));
} else {
return null;
}
});
...
var args33760 = [];
var len__19923__auto___33763 = arguments.length;
var i__19924__auto___33764 = (0);
while(true){
if((i__19924__auto___33764 < len__19923__auto___33763)){
args33760.push((arguments[i__19924__auto___33764]));

var G__33765 = (i__19924__auto___33764 + (1));
i__19924__auto___33764 = G__33765;
continue;
} else {
}
break;
...
//# sourceMappingURL=core.js.map?rel=1445816810705