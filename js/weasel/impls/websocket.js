...
weasel.impls.websocket.IWebSocket = {};
...
var m__19521__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__19520__auto__)]);
if(!((m__19521__auto__ == null))){
return m__19521__auto__.call(null,this$);
} else {
var m__19521__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);
...
var args36044 = [];
var len__19923__auto___36047 = arguments.length;
var i__19924__auto___36048 = (0);
while(true){
if((i__19924__auto___36048 < len__19923__auto___36047)){
args36044.push((arguments[i__19924__auto___36048]));

var G__36049 = (i__19924__auto___36048 + (1));
i__19924__auto___36048 = G__36049;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args36044.length)].join('')));
...
//# sourceMappingURL=websocket.js.map?rel=1445816815235