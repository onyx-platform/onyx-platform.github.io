...
var slc = (rngs[(32)]);
var and__18872__auto__ = (slc === (32));
if(and__18872__auto__){
var or__18884__auto__ = (shift === (5));
if(or__18884__auto__){
return or__18884__auto__;
} else {
var G__32423 = (root.arr[(slc - (1))]);
var G__32424 = (shift - (5));
var G__32425 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__32423;
shift = G__32424;
cnt = G__32425;
continue;
...
var rngs_32434 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_32435 = (rngs_32434[(0)]);
var new_rngs_32436 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_32437 = (rngs_32434[(32)]);
cljs.core.array_copy.call(null,rngs_32434,(1),new_rngs_32436,(0),(lim_32437 - (1)));

var i_32438 = (0);
while(true){
if((i_32438 < lim_32437)){
(new_rngs_32436[i_32438] = ((new_rngs_32436[i_32438]) - rng0_32435));
...
(new_rngs_32436[(32)] = ((rngs_32434[(32)]) - (1)));

(new_rngs_32436[((rngs_32434[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_32436);
} else {
}
...
while(true){
if((i_32440 <= li)){
(new_rngs[i_32440] = ((new_rngs[(i_32440 - (1))]) + step));

var G__32441 = (i_32440 + (1));
i_32440 = G__32441;
continue;
} else {
}
...
while(true){
if((i_32442 <= li)){
(new_rngs[i_32442] = ((rngs[i_32442]) - d));

var G__32443 = (i_32442 + (1));
i_32442 = G__32443;
continue;
} else {
}
...
while(true){
if((j_32444 <= i)){
(rngs[j_32444] = r_32445);

var G__32446 = (j_32444 + (1));
var G__32447 = (r_32445 + step);
j_32444 = G__32446;
r_32445 = G__32447;
continue;
} else {
...
var rngs = ((!(reg_QMARK_))?(function (){var G__32449 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__32449[(0)] = node.arr.length);
...
var arr_32450__$1 = arr;
var shift_32451__$1 = shift;
while(true){
if((shift_32451__$1 === (5))){
if(!(reg_QMARK_)){
(arr_32450__$1[(32)] = rngs);
} else {
}

(arr_32450__$1[(0)] = node);
} else {
var a_32452 = (new Array(len));
var e_32453 = cljs.core.__GT_VectorNode.call(null,null,a_32452);
(arr_32450__$1[(0)] = e_32453);
...
var G__32454 = a_32452;
var G__32455 = (shift_32451__$1 - (5));
arr_32450__$1 = G__32454;
shift_32451__$1 = G__32455;
continue;
}
break;
}
...
var reg_QMARK_ = (function (){var and__18872__auto__ = clojure.core.rrb_vector.nodes.regular_QMARK_.call(null,node);
...
//# sourceMappingURL=nodes.js.map?rel=1445816808154