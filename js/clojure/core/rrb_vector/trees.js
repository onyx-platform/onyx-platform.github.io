...
var G__32487 = (node__$1.arr[((i__$1 >> shift__$2) & (31))]);
var G__32488 = (shift__$2 - (5));
node__$1 = G__32487;
shift__$2 = G__32488;
continue;
}
...
var G__32490 = i__$2;
var G__32491 = (node.arr[j]);
var G__32492 = (shift__$1 - (5));
i__$1 = G__32490;
node = G__32491;
shift__$1 = G__32492;
continue;
...
var n_32497 = ret;
var shift_32498__$1 = shift;
while(true){
var arr_32499__$1 = n_32497.arr;
var subidx_32500 = (((cnt - (1)) >> shift_32498__$1) & (31));
if((shift_32498__$1 === (5))){
(arr_32499__$1[subidx_32500] = tail_node);
} else {
var temp__4423__auto___32501 = (arr_32499__$1[subidx_32500]);
if(cljs.core.truth_(temp__4423__auto___32501)){
var child_32502 = temp__4423__auto___32501;
var new_carr_32503 = cljs.core.aclone.call(null,child_32502.arr);
var new_child_32504 = cljs.core.__GT_VectorNode.call(null,root_edit,new_carr_32503);
(arr_32499__$1[subidx_32500] = new_child_32504);

var G__32505 = new_child_32504;
var G__32506 = (shift_32498__$1 - (5));
n_32497 = G__32505;
shift_32498__$1 = G__32506;
continue;
} else {
(arr_32499__$1[subidx_32500] = clojure.core.rrb_vector.trees.new_path.call(null,tail_node.arr,root_edit,(shift_32498__$1 - (5)),tail_node));
}
}
break;
}
...
var shift_32508__$1 = shift;
var node_32509__$1 = node;
while(true){
if((shift_32508__$1 === (0))){
var arr_32510 = node_32509__$1.arr;
(arr_32510[(i & (31))] = val);
} else {
var arr_32511 = node_32509__$1.arr;
var subidx_32512 = ((i >> shift_32508__$1) & (31));
var child_32513 = clojure.core.rrb_vector.nodes.clone.call(null,shift_32508__$1,(arr_32511[subidx_32512]));
(arr_32511[subidx_32512] = child_32513);

var G__32514 = (shift_32508__$1 - (5));
var G__32515 = child_32513;
shift_32508__$1 = G__32514;
node_32509__$1 = G__32515;
continue;
}
break;
}
...
//# sourceMappingURL=trees.js.map?rel=1445816808357