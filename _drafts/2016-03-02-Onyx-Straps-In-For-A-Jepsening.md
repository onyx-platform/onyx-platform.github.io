...
Retrieve your application's logs upon test completion. This one should be obvious - it is very helpful to be able to correlate the info and exceptions logged by your application with the events generated by Jepsen.
